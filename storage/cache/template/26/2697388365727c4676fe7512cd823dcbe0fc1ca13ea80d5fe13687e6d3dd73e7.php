...
class __TwigTemplate_c0d0c1a5832f0e92ef17889e5f5542dee9f7f5e80894f1b87b98a7b55baad904 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t<a href=\"";
                // line 240
                echo twig_get_attribute($this->env, $this->source, $context["category1"], "href", [], "any", false, false, false, 240);
                echo "\" class=\"zoom-img\">
\t\t\t\t\t\t\t<img src=\"";
                // line 241
                echo twig_get_attribute($this->env, $this->source, $context["category1"], "thumb", [], "any", false, false, false, 241);
                echo " \" width=\"100%\" alt=\"\" class=\"serv-img\" title=\"\"/>
\t\t\t\t\t\t</a>
\t\t\t\t\t\t<h5 class=\" mt-2 mb-2\">
\t\t\t\t\t\t\t<span style=\"z-index:2;    position: relative;\">";
                // line 244
                echo twig_get_attribute($this->env, $this->source, $context["category1"], "name", [], "any", false, false, false, 244);
                echo "</span>
\t\t\t\t\t\t</h5>
\t\t\t\t\t</div>
