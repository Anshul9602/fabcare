...
class __TwigTemplate_b5f251a0a7fee3644c4110fd0ab8b7d151cf82c441053c8b1e240e362d564895 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t\t\t\t\t\t\t";
                ...
                if ( !twig_get_attribute($this->env, $this->source, $context["product"], "wish", [], "any", false, false, false, 219)) {
                    // line 220
                    echo "\t\t\t\t\t\t\t\t\t\t\t\t\t\t<button class=\"productBtn \" btnid=\"p-1\">1</button>
