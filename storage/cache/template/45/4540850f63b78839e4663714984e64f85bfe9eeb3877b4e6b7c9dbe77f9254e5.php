...
class __TwigTemplate_6a3f412caa62ae4c8e24d4f7a1fc9604564e991e67eafdffac65ab3776dd7ead extends \Twig\Template
{
    private $source;
    private $macros = [];
...
<section>
\tclass=\"shopy_by_room separation\"<div>
\t\tclass=\"container\"<div>
\t\t\tclass=\"row\"<div>
\t\t\t\tclass=\"col-md-8\"<div>
\t\t\t\t\tclass=\"main_text\"Expert Fabric Care<span>
\t\t\t\t\t\tstyle=\"color: #5d5443;\"Services</span>
\t\t\t\t</div>
\t\t\t</div>
\t\t\t<div>
\t\t\t\tclass=\"col-md-4\"<div>
\t\t\t\t\tclass=\"text2\"Tailored services for every fabric.</div>
\t\t\t\t<div>
\t\t\t\t\tclass=\"mob_center\"style=\"margin-top: 30px;\"<a>
\t\t\t\t\t\tclass=\"text_btn \"href=\"index.php?route=information/contact\"<span>
\t\t\t\t\t\t\tclass=\"elementor-button-content-wrapper\"<span>
\t\t\t\t\t\t\t\tclass=\"elementor-button-text\"Schedule your pickup</span>
\t\t\t\t\t\t</span>
\t\t\t\t\t</a>
\t\t\t\t</div>
...
<section>
\tclass=\"shopy_by_room separation\"<img>src=\"image/pe/b1.png\"style=\"width:100%;\"</section>
...
";
    ...
    {
        return array (  292 => 250,  268 => 229,  37 => 1,);
    }
