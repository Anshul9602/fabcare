...
class __TwigTemplate_012819262f9617c64684b1a43ab3286c2dd45789dcc5f8c513c63319461106ff extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t\t\t\t\t<li>This product comes with ";
        // line 828
        echo ($context["warranty1"] ?? null);
        echo " warranty, limited warranty
\t\t\t\t\t\t\t\t\t\t\t\tcovers
...
\t\t\t\t\t\t<a href=\"";
                // line 938
                echo twig_get_attribute($this->env, $this->source, $context["product"], "href", [], "any", false, false, false, 938);
                echo "\">
\t\t\t\t\t\t\t<img src=\"";
                // line 939
                echo twig_get_attribute($this->env, $this->source, $context["product"], "thumb", [], "any", false, false, false, 939);
                echo "\" alt=\"";
                echo twig_get_attribute($this->env, $this->source, $context["product"], "name", [], "any", false, false, false, 939);
                echo "\" title=\"";
                echo twig_get_attribute($this->env, $this->source, $context["product"], "name", [], "any", false, false, false, 939);
...
\t\t\t\t\t\t<p class=\"product_name mt-10 font-16 mt-10\">";
                // line 943
                echo twig_get_attribute($this->env, $this->source, $context["product"], "name", [], "any", false, false, false, 943);
                echo "</p>
\t\t\t\t\t</div>
\t\t\t\t\t";
                // line 945
                if (twig_get_attribute($this->env, $this->source, $context["product"], "price", [], "any", false, false, false, 945)) {
                    // line 946
                    echo "\t\t\t\t\t<p class=\"price\">
\t\t\t\t\t\t";
                    // line 947
                    if ( !twig_get_attribute($this->env, $this->source, $context["product"], "special", [], "any", false, false, false, 947)) {
                        // line 948
                        echo "\t\t\t\t\t\t";
...
\t\t\t\t\t\t<span style=\"text-decoration:none; color: #6c8bab;font-weight: 600;font-size:16px;\" class=\"off_p\">";
                        // line 952
                        echo twig_get_attribute($this->env, $this->source, $context["product"], "percent", [], "any", false, false, false, 952);
                        echo "%
\t\t\t\t\t\t\tOFF</span>
\t\t\t\t\t\t";
                    }
                    // line 955
                    echo "\t\t\t\t\t\t";
                    if (twig_get_attribute($this->env, $this->source, $context["product"], "tax", [], "any", false, false, false, 955)) {
                        // line 956
...
\t\t\t\t\t\t\t";
                        // line 957
                        echo twig_get_attribute($this->env, $this->source, $context["product"], "tax", [], "any", false, false, false, 957);
                        echo "</span>
\t\t\t\t\t\t";
                    }
                    // line 959
