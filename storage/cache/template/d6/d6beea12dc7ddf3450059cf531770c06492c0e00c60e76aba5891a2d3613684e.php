...
class __TwigTemplate_bb0d07cc42092387ffc773c623897fef7f2d2aae3005401910315503ed1a2d0b extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t\t\t\t\t<p>Closure</p>
\t\t\t\t\t\t\t\t\t\t\t<h5 class=\"mb-2\"style=\"border-bottom: 1px solid gray;\">Button</h5>
\t\t\t\t\t\t\t\t\t\t</div>
...
\t\t\t\t\t\t\t\t\t";
                // line 431
                if ( !twig_get_attribute($this->env, $this->source, $context["product"], "wish", [], "any", false, false, false, 431)) {
                    // line 432
                    ...
                    echo "\" btnname=\"";
                    echo twig_get_attribute($this->env, $this->source, $context["product"], "name", [], "any", false, false, false, 432);
                    echo "\" btnimg=\"";
...
\t\t\t\t\t\t\t\t\t\t\t";
                // line 447
                if (twig_get_attribute($this->env, $this->source, $context["product"], "price", [], "any", false, false, false, 447)) {
                    // line 448
...
\t\t\t\t\t\t\t\t\t\t\t\t\t";
                    ...
                    if ( !twig_get_attribute($this->env, $this->source, $context["product"], "special", [], "any", false, false, false, 449)) {
                        ...
                        echo twig_get_attribute($this->env, $this->source, $context["product"], "price", [], "any", false, false, false, 450);
                        echo "</span>
\t\t\t\t\t\t\t\t\t\t\t\t\t";
                    } else {
                        // line 452
...
\t\t\t\t\t\t\t\t\t\t\t\t\t";
                    ...
                    // line 455
                    echo "\t\t\t\t\t\t\t\t\t\t\t\t\t";
                    if (twig_get_attribute($this->env, $this->source, $context["product"], "tax", [], "any", false, false, false, 455)) {
                        // line 456
...
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t";
                        // line 457
                        echo twig_get_attribute($this->env, $this->source, $context["product"], "tax", [], "any", false, false, false, 457);
                        echo "</span>
\t\t\t\t\t\t\t\t\t\t\t\t\t";
                    }
                    // line 459
...
\t\t\t\t\t\t\t\t\t\t\t";
                ...
                // line 461
                echo "\t\t\t\t\t\t\t\t\t\t\t";
                if ((twig_get_attribute($this->env, $this->source, $context["product"], "percent", [], "any", false, false, false, 461) == null)) {
                    // line 462
                    echo "\t\t\t\t\t\t\t\t\t\t\t\t";
                } else {
                    // line 463
                    echo "\t\t\t\t\t\t\t\t\t\t\t\t\t<span style=\"text-decoration:none; color: #6c8bab;font-weight: 600;font-size:14px;\" class=\"off_p\">";
                    echo twig_get_attribute($this->env, $this->source, $context["product"], "percent", [], "any", false, false, false, 463);
                    echo "% OFF</span>
\t\t\t\t\t\t\t\t\t\t\t";
                }
                // line 465
