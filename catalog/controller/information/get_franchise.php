<?php
class ControllerInformationGetFranchise extends Controller {
	private $error = array();

	public function index() {
		$this->load->language('information/GetFranchise');

		$this->document->setTitle($this->language->get('Get-Franchise'));
		...
		$this->response->setOutput($this->load->view('common/getf', $data));
	}
