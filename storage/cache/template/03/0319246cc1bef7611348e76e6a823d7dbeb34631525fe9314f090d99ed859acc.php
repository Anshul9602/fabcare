...
class __TwigTemplate_cf2b764896148e33a2cf905154682a34de32136d4c66cb07ddaa5d8d1d6cadfb extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t\t\t\t";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["category"]) {
                // line 279
                echo "\t\t\t\t\t\t\t\t\t\t\t";
                if (twig_get_attribute($this->env, $this->source, $context["category"], "children", [], "any", false, false, false, 279)) {
                    // line 280
                    echo "\t\t\t\t\t\t\t\t\t\t\t\t<li class=\"menu-item-has-children\">
\t\t\t\t\t\t\t\t\t\t\t\t\t";
                    // line 281
                    $context["myVariable"] = twig_get_attribute($this->env, $this->source, $context["category"], "href", [], "any", false, false, false, 281);
                    // line 282
                    echo "\t\t\t\t\t\t\t\t\t\t\t\t\t<a href=\"";
                    echo twig_get_attribute($this->env, $this->source, $context["category"], "href", [], "any", false, false, false, 282);
                    echo "\">";
                    echo twig_get_attribute($this->env, $this->source, $context["category"], "name", [], "any", false, false, false, 282);
                    echo "</a>
\t\t\t\t\t\t\t\t\t\t\t\t\t<ul class=\"dropdown\">
\t\t\t\t\t\t\t\t\t\t\t\t\t\t";
                    // line 284
                    $context['_parent'] = $context;
                    $context['_seq'] = twig_ensure_traversable(twig_array_batch(twig_get_attribute($this->env, $this->source, $context["category"], "children", [], "any", false, false, false, 284), (twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, $context["category"], "children", [], "any", false, false, false, 284)) / twig_round(twig_get_attribute($this->env, $this->source, $context["category"], "column", [], "any", false, false, false, 284), 1, "ceil"))));
...
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<a href=\"";
                            // line 287
                            echo twig_get_attribute($this->env, $this->source, $context["child"], "href", [], "any", false, false, false, 287);
                            echo "\">";
                            echo twig_get_attribute($this->env, $this->source, $context["child"], "name", [], "any", false, false, false, 287);
                            echo "</a>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</li>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t";
                        }
...
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t";
                        // line 300
                        if (twig_get_attribute($this->env, $this->source, $context["category"], "children", [], "any", false, false, false, 300)) {
                            // line 301
                            echo "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<li class=\"col-md-2 pr-0\" style=\"align-items: center;\">
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t";
                            // line 302
                            $context["myVariable"] = twig_get_attribute($this->env, $this->source, $context["category"], "href", [], "any", false, false, false, 302);
                            // line 303
                            echo "
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<a href=\"";
                            // line 304
                            echo twig_get_attribute($this->env, $this->source, $context["category"], "href", [], "any", false, false, false, 304);
                            echo "\" style=\"color:#0e212c;    font-weight: 800;\">";
                            echo twig_get_attribute($this->env, $this->source, $context["category"], "name", [], "any", false, false, false, 304);
                            echo "</a>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<ul class=\"\">
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t";
                            // line 306
                            $context['_parent'] = $context;
                            $context['_seq'] = twig_ensure_traversable(twig_array_batch(twig_get_attribute($this->env, $this->source, $context["category"], "children", [], "any", false, false, false, 306), (twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, $context["category"], "children", [], "any", false, false, false, 306)) / twig_round(twig_get_attribute($this->env, $this->source, $context["category"], "column", [], "any", false, false, false, 306), 1, "ceil"))));
                            foreach ($context['_seq'] as $context["_key"] => $context["children"]) {
                                // line 307
                                echo "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t";
                                $context['_parent'] = $context;
...
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<a href=\"";
                                    // line 309
                                    echo twig_get_attribute($this->env, $this->source, $context["child"], "href", [], "any", false, false, false, 309);
                                    echo "\">";
                                    echo twig_get_attribute($this->env, $this->source, $context["child"], "name", [], "any", false, false, false, 309);
                                    echo "</a>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</li>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t";
                                }
...
";
    ...
    {
        return array (  719 => 382,  692 => 357,  687 => 355,  683 => 354,  679 => 353,  674 => 352,  669 => 350,  665 => 349,  661 => 348,  657 => 347,  653 => 346,  648 => 345,  646 => 344,  629 => 329,  624 => 326,  618 => 325,  611 => 320,  604 => 318,  597 => 313,  591 => 312,  580 => 309,  577 => 308,  572 => 307,  568 => 306,  561 => 304,  558 => 303,  556 => 302,  553 => 301,  551 => 300,  548 => 299,  544 => 298,  538 => 295,  535 => 294,  530 => 291,  524 => 290,  513 => 287,  510 => 286,  505 => 285,  501 => 284,  493 => 282,  491 => 281,  488 => 280,  485 => 279,  481 => 278,  477 => 276,  475 => 275,  427 => 230,  421 => 227,  412 => 221,  408 => 220,  384 => 199,  365 => 183,  358 => 179,  347 => 173,  342 => 170,  334 => 167,  326 => 164,  323 => 163,  315 => 160,  307 => 157,  299 => 154,  296 => 153,  294 => 152,  284 => 147,  272 => 138,  258 => 131,  254 => 130,  198 => 76,  189 => 74,  184 => 73,  173 => 71,  169 => 70,  166 => 69,  157 => 67,  152 => 66,  139 => 64,  135 => 63,  92 => 22,  86 => 20,  83 => 19,  77 => 17,  75 => 16,  71 => 15,  66 => 13,  55 => 7,  47 => 4,  41 => 3,  37 => 1,);
    }
