...
class __TwigTemplate_75f23bcb7068b62f338ae1d01355690fcde4e1e592461ae2dfc52cda6f93945f extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t<div class=\"row mt-4\">
\t\t\t\t
\t\t\t\t\t<div class=\"col-sm-6 col-6 text-center mt-2\">
\t\t\t\t\t\t<a href=\"\" class=\"zoom-img\">
\t\t\t\t\t\t\t<img src=\" \" width=\"100%\" alt=\"\" class=\"serv-img\" title=\"\"/>
\t\t\t\t\t\t</a>
\t\t\t\t\t\t<h5 class=\" mt-2 mb-2\">
\t\t\t\t\t\t\t<span style=\"z-index:2;    position: relative;\">knm</span>
\t\t\t\t\t\t</h5>
\t\t\t\t\t</div>
