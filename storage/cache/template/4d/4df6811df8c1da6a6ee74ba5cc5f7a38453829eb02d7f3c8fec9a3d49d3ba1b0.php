...
class __TwigTemplate_da712e83b0acaa98e76dcd99f7248934b64f88509f513f6529e5a6008158a0f7 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t\t\t";
        ...
        echo "
\t\t\t\t\t\t\t\t</button>
\t\t\t\t\t\t\t\t<button type=\"button\" id=\"button-buy\" style='float:right; max-width:40%;background-color:#ED6940' class=\"col-md-5 col-5 btn btn-primary btn-lg \">
...
\t\t\t\t\t\t\t\t\t";
                // line 412
                if ( !twig_get_attribute($this->env, $this->source, $context["product"], "wish", [], "any", false, false, false, 412)) {
                    // line 413
...
\t\t\t\t\t\t\t\t\t\t\t\t<h4 class=\"product_name\">";
                // line 423
                echo twig_get_attribute($this->env, $this->source, $context["product"], "name", [], "any", false, false, false, 423);
                echo "</h4>
...
\t\t\t\t\t\t\t\t\t\t\t";
                ...
                // line 442
                echo "\t\t\t\t\t\t\t\t\t\t\t";
                if ((twig_get_attribute($this->env, $this->source, $context["product"], "percent", [], "any", false, false, false, 442) == null)) {
                    // line 443
                    echo "\t\t\t\t\t\t\t\t\t\t\t\t";
                } else {
                    // line 444
                    echo "\t\t\t\t\t\t\t\t\t\t\t\t\t<span style=\"text-decoration:none; color: #6c8bab;font-weight: 600;font-size:14px;\" class=\"off_p\">";
                    echo twig_get_attribute($this->env, $this->source, $context["product"], "percent", [], "any", false, false, false, 444);
                    echo "% OFF</span>
\t\t\t\t\t\t\t\t\t\t\t";
                }
                // line 446
