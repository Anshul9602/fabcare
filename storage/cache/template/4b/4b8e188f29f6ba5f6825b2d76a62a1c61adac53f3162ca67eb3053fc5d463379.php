...
class __TwigTemplate_32a7607fb3c56ea38be845bb54dbec72920d2a8b144d29c675b1ec6bad7ae583 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["product"]) {
                // line 936
                echo "\t\t\t\t<div class=\"swiper-slide\" style=\"max-width:265px;margin-right: 15px !important;\">
\t\t\t\t\t<div class=\"product-card \">
\t\t\t\t\t\t<div class=\"image\">
\t\t\t\t\t\t\t<a onclick=\"\" href=\"";
                // line 939
                echo twig_get_attribute($this->env, $this->source, $context["product"], "href", [], "any", false, false, false, 939);
                echo "\">
\t\t\t\t\t\t\t\t<img onclick=\"\" style=\"z-index: 99999999\" src=\"";
                // line 940
                echo twig_get_attribute($this->env, $this->source, $context["product"], "thumb", [], "any", false, false, false, 940);
                echo "\" alt=\"";
                echo twig_get_attribute($this->env, $this->source, $context["product"], "name", [], "any", false, false, false, 940);
                echo "\" title=\"";
                echo twig_get_attribute($this->env, $this->source, $context["product"], "name", [], "any", false, false, false, 940);
...
\t\t\t\t\t\t<a onclick=\"\" href=\"";
                ...
                echo "\">
\t\t\t\t\t\t\t<h6 class=\"product_name mt-1\" style=\"color: black\">
\t\t\t\t\t\t\t\t";
                // line 945
...
\t\t\t\t\t\t";
                // line 948
                if (twig_get_attribute($this->env, $this->source, $context["product"], "price", [], "any", false, false, false, 948)) {
                    // line 949
                    echo "\t\t\t\t\t\t<p class=\"price mt-1\">
\t\t\t\t\t\t\t";
                    // line 950
                    if ( !twig_get_attribute($this->env, $this->source, $context["product"], "special", [], "any", false, false, false, 950)) {
                        // line 951
                        echo "\t\t\t\t\t\t\t";
...
\t\t\t\t\t\t\t<span style=\"white-space:nowrap;font-weight: 600;color: #ff7c47;font-size:18px;\" class=\"price-new\">";
                        // line 954
                        echo twig_get_attribute($this->env, $this->source, $context["product"], "special", [], "any", false, false, false, 954);
                        echo "&nbsp; </span>
...
\t\t\t\t\t\t\t<span style=\"text-decoration:none; color: #6c8bab;font-weight: 600;font-size:16px;\">";
                        // line 956
                        echo twig_get_attribute($this->env, $this->source, $context["product"], "percent", [], "any", false, false, false, 956);
                        echo "%
\t\t\t\t\t\t\t\tOFF</span>
\t\t\t\t\t\t\t";
                    }
...
<script>
\tvar swiper = new Swiper(\".topSwiperRe\", {
\t\tpagination: {
