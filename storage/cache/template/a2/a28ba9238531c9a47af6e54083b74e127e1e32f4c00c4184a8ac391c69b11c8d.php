...
class __TwigTemplate_25ab6f2ed7b74be191514702f666bbb70fe83573f326c64af129b61562eb1e9b extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t\t\t\t<a style=\"font-size:14px;text-transform:uppercase;position: absolute;top: 20px;right: 10px;    cursor: pointer;\" onclick=\"wishlist.add('";
                // line 160
