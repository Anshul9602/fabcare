...
class __TwigTemplate_a862812ac7d122b45748d44da6e4bfa5c949a608418674ed7e5f4b2e6767fc38 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
console.log(wish_total);
document.getElementById('wish_total').innerHTML = console.log(wish_total);
\t</script>
