...
class __TwigTemplate_e0390b481a6acad218eaf0304cc8c666d498f21d83911b9f38c6909d10d85cf1 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t\t\t";
        ...
        echo "
\t\t\t\t\t\t\t\t</button>
\t\t\t\t\t\t\t\t<button type=\"button\" id=\"button-buy\" style='float:right; max-width:40%;' class=\"col-md-6 col-5 btn btn-primary btn-lg \">
