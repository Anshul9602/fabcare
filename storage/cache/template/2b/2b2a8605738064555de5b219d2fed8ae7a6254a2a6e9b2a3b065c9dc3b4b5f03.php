...
class __TwigTemplate_cb3506f97e5095bba037d36f93314211be04671c5c6772017b98f36c45528bac extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t\t<button type=\"button\" style='float:left; max-width:210px' id=\"button-cart\" data-loading-text=\"";
        // line 365
        echo ($context["text_loading"] ?? null);
        echo "\" class=\"btn col-md-6 btn-primary btn-lg btn-block\">
                     \t\t\t\t<li class=\"fa fa-shopping-cart\"></li>  ";
        // line 366
        echo ($context["button_cart"] ?? null);
        echo "
\t\t\t\t\t\t\t\t</button>
\t\t\t\t\t\t\t\t\t<button type=\"button\" id=\"button-buy\" style='float:right; background-color:#4a4975' class=\"col-md-5 btn btn-primary btn-lg \">
