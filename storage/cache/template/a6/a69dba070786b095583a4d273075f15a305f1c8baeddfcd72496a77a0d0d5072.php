...
class __TwigTemplate_fadf1d1c0719b0773719b9a31a4d7fe1e8828afd338c9a0ee9b89a73e969cd7e extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["product"]) {
                // line 399
                echo "\t\t\t\t<div class=\"col-sm-4 col-6 mt-4\">
...
\t\t\t\t\t\t\t<a class=\"wishlist_link\" onclick=\"wishlist.add('";
                // line 407
                echo twig_get_attribute($this->env, $this->source, $context["product"], "product_id", [], "any", false, false, false, 407);
                echo "');\">
\t\t\t\t\t\t\t\t";
                // line 408
                if ( !twig_get_attribute($this->env, $this->source, $context["product"], "wish", [], "any", false, false, false, 408)) {
                    // line 409
                    ...
                    echo "\" btnprice=\"";
                    echo twig_get_attribute($this->env, $this->source, $context["product"], "price", [], "any", false, false, false, 409);
                    echo "\" btnsprice=\"";
                    echo twig_get_attribute($this->env, $this->source, $context["product"], "special", [], "any", false, false, false, 409);
...
\t\t\t\t\t\t\t\t\t\t<a target=\"_blank\" href=\"";
                // line 418
                echo twig_get_attribute($this->env, $this->source, $context["product"], "href", [], "any", false, false, false, 418);
                echo "\">
...
\t\t\t\t\t\t\t\t\t\t\t\t";
                        ...
                        // line 429
                        echo "\t\t\t\t\t\t\t\t\t\t\t\t\t<span class=\"price-new\">";
                        echo twig_get_attribute($this->env, $this->source, $context["product"], "special", [], "any", false, false, false, 429);
                        echo "</span>
...
\t\t\t\t\t\t\t\t\t\t\t\t";
                    ...
                    // line 432
                    echo "\t\t\t\t\t\t\t\t\t\t\t\t";
                    if (twig_get_attribute($this->env, $this->source, $context["product"], "tax", [], "any", false, false, false, 432)) {
                        // line 433
...
\t\t\t\t\t\t\t\t\t\t";
                ...
                // line 438
                echo "\t\t\t\t\t\t\t\t\t\t";
                if ((twig_get_attribute($this->env, $this->source, $context["product"], "percent", [], "any", false, false, false, 438) == null)) {
                    // line 439
                    echo "\t\t\t\t\t\t\t\t\t\t\t";
                } else {
                    // line 440
                    echo "\t\t\t\t\t\t\t\t\t\t\t\t<span style=\"text-decoration:none; color: #6c8bab;font-weight: 600;font-size:14px;\" class=\"off_p\">";
                    echo twig_get_attribute($this->env, $this->source, $context["product"], "percent", [], "any", false, false, false, 440);
                    echo "% OFF</span>
\t\t\t\t\t\t\t\t\t\t";
                }
                // line 442
