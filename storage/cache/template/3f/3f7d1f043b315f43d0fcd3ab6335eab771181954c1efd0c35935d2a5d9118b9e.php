...
class __TwigTemplate_9dceb9883dceefe3ace497ba101142ff11119c193fab782dfa21ba14e0f98c29 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t\t<i class=\"fa fa-heart\" aria-hidden=\"true\" style=\"font-size:17px;\"></i>
\t\t\t\t\t\t\t\tadd to wishlist
\t\t\t\t\t\t\t</a>
\t\t\t\t\t\t</p>
\t\t\t\t\t</div>
