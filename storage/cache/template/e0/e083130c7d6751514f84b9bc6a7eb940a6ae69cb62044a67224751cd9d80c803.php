...
class __TwigTemplate_366408f704c2041261ab83ad753ba695deedec7160bc9d837ef327cba9cbc951 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t";
        // line 49
        $context['_parent'] = $context;
        $context['_seq'] = twig_ensure_traversable(($context["wishlistVar"] ?? null));
...
\t\t\t\t\t";
            // line 55
            if (twig_get_attribute($this->env, $this->source, $context["product"], "productimg", [], "any", false, false, false, 55)) {
                // line 56
                echo "\t\t\t\t\t\t<figure class=\"product-thumb\">
\t\t\t\t\t\t\t<a href=\"";
                // line 57
                echo twig_get_attribute($this->env, $this->source, $context["product"], "producthref", [], "any", false, false, false, 57);
                echo "\">
\t\t\t\t\t\t\t\t<img class=\"pri-img\" src=\"";
                // line 58
                echo twig_get_attribute($this->env, $this->source, $context["product"], "productimg", [], "any", false, false, false, 58);
                echo "\" alt=\"product\">
\t\t\t\t\t\t\t\t<img class=\"sec-img\" src=\"";
                // line 59
                echo twig_get_attribute($this->env, $this->source, $context["product"], "productimg", [], "any", false, false, false, 59);
                echo "\" alt=\"product\">
\t\t\t\t\t\t\t</a>
...
\t\t\t\t\t\t\t\t<a href=\"";
                // line 63
                echo twig_get_attribute($this->env, $this->source, $context["product"], "producthref", [], "any", false, false, false, 63);
                echo "\">
...
\t\t\t\t\t\t\t<a href=\"";
            // line 71
            echo twig_get_attribute($this->env, $this->source, $context["product"], "producthref", [], "any", false, false, false, 71);
            echo "\">
\t\t\t\t\t\t\t\t";
            // line 72
            echo twig_get_attribute($this->env, $this->source, $context["product"], "productname", [], "any", false, false, false, 72);
            echo "
\t\t\t\t\t\t\t</a>
\t\t\t\t\t\t</h6>
\t\t\t\t\t\t";
...
<script>
\tconst wishlistVar = JSON.parse(localStorage.getItem(\"wishlist1\"));
console.log(wishlistVar);
</script>
";
        // line 108
...
";
    ...
    {
        return array (  219 => 108,  208 => 99,  192 => 92,  189 => 91,  182 => 87,  177 => 85,  174 => 84,  167 => 80,  162 => 77,  159 => 76,  157 => 75,  151 => 72,  147 => 71,  143 => 69,  134 => 63,  127 => 59,  123 => 58,  119 => 57,  116 => 56,  114 => 55,  107 => 50,  103 => 49,  84 => 32,  73 => 29,  70 => 28,  66 => 27,  37 => 1,);
    }
