...
class __TwigTemplate_26551861553ac2ece29a3c5fd3489036fc6058a12b9c88142b89f94c6e438544 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t<p class=\"\">GET ADDITIONAL 5% DISCOUNT ON YOUR FIRST PURCHASE. USE CODE:
\t\t\t\t\t\t\t\t<span class=\"color:black;font-weight: 600;font-size: 12px;\">FIRST5</span>
\t\t\t\t\t\t\t</p>
