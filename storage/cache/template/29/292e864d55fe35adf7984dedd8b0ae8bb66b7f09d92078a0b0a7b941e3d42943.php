...
class __TwigTemplate_0223b06f40fd6c7357502322bd3dda2064edfc5de42768fcdb60117b7e00d759 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t\t\t\t\t\t\t";
                ...
                if ( !twig_get_attribute($this->env, $this->source, $context["product"], "wish", [], "any", false, false, false, 220)) {
                    // line 221
                    echo "\t\t\t\t\t\t\t\t\t\t\t\t\t\t<button class=\"productBtn \">id</button>
