...
class __TwigTemplate_c78a4fff98726a6eb150b310a2b8bdeca142b63b6c52e4763d57eac533ad3928 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t\t\t\t\t<strong>";
                // line 565
                echo twig_get_attribute($this->env, $this->source, $context["attribute_group"], "name", [], "any", false, false, false, 565);
                echo "</strong>
\t\t\t\t\t\t\t\t\t\t</td>
\t\t\t\t\t\t\t\t\t</tr>
\t\t\t\t\t\t\t\t</thead>
...
\t\t\t\t\t\t\t\t\t";
                // line 570
                $context['_parent'] = $context;
                $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, $context["attribute_group"], "attribute", [], "any", false, false, false, 570));
                foreach ($context['_seq'] as $context["_key"] => $context["attribute"]) {
                    // line 571
                    echo "\t\t\t\t\t\t\t\t\t\t<tr>
\t\t\t\t\t\t\t\t\t\t\t<td>";
                    // line 572
                    echo twig_get_attribute($this->env, $this->source, $context["attribute"], "name", [], "any", false, false, false, 572);
                    echo "</td>
\t\t\t\t\t\t\t\t\t\t\t<td>";
                    // line 573
                    echo twig_get_attribute($this->env, $this->source, $context["attribute"], "text", [], "any", false, false, false, 573);
                    echo "</td>
\t\t\t\t\t\t\t\t\t\t</tr>
\t\t\t\t\t\t\t\t\t";
                }
...
\t\t\t\t\t\t\t\t<a href=\"";
                // line 905
                echo twig_get_attribute($this->env, $this->source, $context["product"], "href", [], "any", false, false, false, 905);
                echo "\">
\t\t\t\t\t\t\t\t\t<img src=\"";
                // line 906
                echo twig_get_attribute($this->env, $this->source, $context["product"], "thumb", [], "any", false, false, false, 906);
                echo "\" alt=\"";
                echo twig_get_attribute($this->env, $this->source, $context["product"], "name", [], "any", false, false, false, 906);
                echo "\" title=\"";
                echo twig_get_attribute($this->env, $this->source, $context["product"], "name", [], "any", false, false, false, 906);
...
\t\t\t\t\t\t\t\t<p class=\"product_name mt-10 font-16 mt-10\">";
                // line 910
                echo twig_get_attribute($this->env, $this->source, $context["product"], "name", [], "any", false, false, false, 910);
                echo "</p>
\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t";
                // line 912
                if (twig_get_attribute($this->env, $this->source, $context["product"], "price", [], "any", false, false, false, 912)) {
                    // line 913
                    echo "\t\t\t\t\t\t\t\t<p class=\"price\">
\t\t\t\t\t\t\t\t\t";
                    // line 914
                    if ( !twig_get_attribute($this->env, $this->source, $context["product"], "special", [], "any", false, false, false, 914)) {
                        // line 915
                        echo "\t\t\t\t\t\t\t\t\t\t";
                        echo twig_get_attribute($this->env, $this->source, $context["product"], "price", [], "any", false, false, false, 915);
                        echo "
\t\t\t\t\t\t\t\t\t";
                    } else {
                        // line 917
                        echo "\t\t\t\t\t\t\t\t\t\t<span class=\"price-new\">";
                        echo twig_get_attribute($this->env, $this->source, $context["product"], "special", [], "any", false, false, false, 917);
                        echo "</span>
\t\t\t\t\t\t\t\t\t\t<span class=\"price-old\" style=\"text-decoration: line-through;\">";
                        // line 918
                        echo twig_get_attribute($this->env, $this->source, $context["product"], "price", [], "any", false, false, false, 918);
                        echo "</span><br>
\t\t\t\t\t\t\t\t\t\t<span style=\"text-decoration:none; color: #6c8bab;font-weight: 600;font-size:16px;\">";
                        // line 919
                        echo twig_get_attribute($this->env, $this->source, $context["product"], "percent", [], "any", false, false, false, 919);
                        echo "% OFF</span>
\t\t\t\t\t\t\t\t\t";
                    }
                    // line 921
                    echo "\t\t\t\t\t\t\t\t\t";
                    if (twig_get_attribute($this->env, $this->source, $context["product"], "tax", [], "any", false, false, false, 921)) {
                        // line 922
...
\t\t\t\t\t\t\t\t\t\t\t";
                        // line 923
                        echo twig_get_attribute($this->env, $this->source, $context["product"], "tax", [], "any", false, false, false, 923);
                        echo "</span>
\t\t\t\t\t\t\t\t\t";
                    }
                    // line 925
