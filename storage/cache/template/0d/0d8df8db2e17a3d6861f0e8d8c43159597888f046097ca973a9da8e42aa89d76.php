...
class __TwigTemplate_1791700b24c0cfe87a2f0cca9619e9e48fffaa5bc75f16ba84fb2c97105eb78d extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t<a style=\"font-size:14px; text-transform:uppercase ;cursor:pointer;\" id=\"fade\" onclick=\"wishlist.add('";
        // line 224
        echo twig_get_attribute($this->env, $this->source, ($context["product"] ?? null), "product_id", [], "any", false, false, false, 224);
        echo "');\">
