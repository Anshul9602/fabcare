...
class __TwigTemplate_394d6a2868e57a2adaeb941919d133f56311520b1c8a18a470119cb784f804f5 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t\t<p class=\"new-font pb-1\"><span style=\"font-weight: 600;\">Email:</span> info@fabcare.in  </p>
\t\t\t\t\t\t\t</li>
\t\t\t\t\t\t\t<li>
\t\t\t\t\t\t\t\t<i class=\"fa fa-phone\"></i>
\t\t\t\t\t\t\t\t<p class=\"new-font pb-1\">
\t\t\t\t\t\t\t\t\t<span style=\"font-weight: 600;\">Customer Care:</span> +91-8048263803
\t\t\t\t\t\t\t\t</p>
\t\t\t\t\t\t\t</li>
\t\t\t\t\t\t</ul>
\t\t\t\t\t</div>
