...
class __TwigTemplate_8ca2aa94292b789d9e69de3dd771e1f16f7120b1bede0188ca91b914273ed059 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t\t\t\t\t\t\t<i class=\"pe-7s-like\" btnid=\"";
        // line 216
        echo twig_get_attribute($this->env, $this->source, ($context["product"] ?? null), "product_id", [], "any", false, false, false, 216);
        echo "\"
\t\t\t\t\t\t\t\t\t\t\t\t\t\tbtnname=\"";
        // line 217
        echo twig_get_attribute($this->env, $this->source, ($context["product"] ?? null), "name", [], "any", false, false, false, 217);
        echo "\" btnimg=\"";
        echo twig_get_attribute($this->env, $this->source, ($context["product"] ?? null), "thumb", [], "any", false, false, false, 217);
        echo "\"
\t\t\t\t\t\t\t\t\t\t\t\t\t\tbtnhref=\"";
        // line 218
        echo twig_get_attribute($this->env, $this->source, ($context["product"] ?? null), "href", [], "any", false, false, false, 218);
        echo "\" btnprice=\"";
        echo twig_get_attribute($this->env, $this->source, ($context["product"] ?? null), "price", [], "any", false, false, false, 218);
        echo "\"
\t\t\t\t\t\t\t\t\t\t\t\t\t\tbtnsprice=\"";
        // line 219
        echo twig_get_attribute($this->env, $this->source, ($context["product"] ?? null), "special", [], "any", false, false, false, 219);
        echo "\"
\t\t\t\t\t\t\t\t\t\t\t\t\t\tstyle=\"color: #4a4975;
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tfont-size:35px;\"></i>
\t\t\t\t\t\t\t\t\t\t\t\t</a>
...
\t\t\t\t\t\t\t\t\t";
                    // line 352
                    if ((twig_get_attribute($this->env, $this->source, $context["category"], "name", [], "any", false, false, false, 352) == "New")) {
                        // line 353
                        echo "\t\t\t\t\t<a href=\" ";
...
\t\t\t\t\t\t";
                        // line 354
                        echo twig_get_attribute($this->env, $this->source, $context["category"], "name", [], "any", false, false, false, 354);
                        echo "</a>
\t\t\t\t\t";
                    } else {
                        // line 356
...
\t\t\t\t\t<a href=\" ";
                        // line 357
                        echo twig_get_attribute($this->env, $this->source, $context["category"], "href", [], "any", false, false, false, 357);
                        echo " \">
\t\t\t\t\t\t";
                        // line 358
                        echo twig_get_attribute($this->env, $this->source, $context["category"], "name", [], "any", false, false, false, 358);
                        echo "</a>
\t\t\t\t\t";
                    }
                    // line 359
...
\t</script>
    ...
    {
        return array (  746 => 420,  719 => 395,  714 => 393,  710 => 392,  706 => 391,  701 => 390,  696 => 388,  692 => 387,  688 => 386,  684 => 385,  680 => 384,  675 => 383,  673 => 382,  655 => 366,  650 => 363,  644 => 362,  639 => 359,  634 => 358,  630 => 357,  627 => 356,  622 => 354,  617 => 353,  615 => 352,  611 => 350,  606 => 347,  600 => 346,  589 => 343,  586 => 342,  581 => 341,  578 => 340,  576 => 339,  568 => 337,  566 => 336,  563 => 335,  560 => 334,  556 => 333,  552 => 331,  550 => 330,  538 => 321,  502 => 288,  495 => 284,  486 => 278,  482 => 277,  448 => 246,  430 => 231,  422 => 226,  412 => 219,  406 => 218,  400 => 217,  396 => 216,  392 => 215,  388 => 214,  383 => 211,  375 => 208,  367 => 205,  364 => 204,  356 => 201,  348 => 198,  340 => 195,  337 => 194,  335 => 193,  324 => 187,  312 => 178,  297 => 170,  293 => 169,  190 => 68,  181 => 66,  176 => 65,  165 => 63,  161 => 62,  158 => 61,  149 => 59,  144 => 58,  131 => 56,  127 => 55,  92 => 22,  86 => 20,  83 => 19,  77 => 17,  75 => 16,  71 => 15,  66 => 13,  54 => 6,  47 => 4,  41 => 3,  37 => 1,);
    }
