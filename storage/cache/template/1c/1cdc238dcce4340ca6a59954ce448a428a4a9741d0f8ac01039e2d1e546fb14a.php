...
class __TwigTemplate_3e8b54ccd3edd55d663fd23636fa3df4e022f7f8e3e3506a488a9b98b69cc188 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
<script>
  ...
  var swiper = new Swiper(\".topSwiper\", {
    ...
    autoplay: true,
     autoplay: {
        delay: 10000, // Set autoplay time to 2 seconds (2000 milliseconds)
    },
    // Default parameters
    slidesPerView: 3,
    spaceBetween: 20,
