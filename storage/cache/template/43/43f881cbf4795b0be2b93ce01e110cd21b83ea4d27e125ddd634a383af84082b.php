...
class __TwigTemplate_a23fb7bd8d762e7db93bd54f6b6f481fc2e9b2b4ae52a8e5622f7d03407c89c9 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
<script>
  ...
  var swiper = new Swiper(\".topSwiper\", {
    ...
    autoplay: true,
     autoplay: {
        delay: 2000, // Set autoplay time to 2 seconds (2000 milliseconds)
    },
    // Default parameters
    slidesPerView: 3,
    spaceBetween: 20,
