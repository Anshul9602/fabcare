...
class __TwigTemplate_4b2d5627e06555936929eddb5766f459396ef482431b23c3ced252a8b7ab33f7 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t\t\t<h3 class=\"pb-3 nav-tabs\">Specifications</h3>
\t\t\t\t\t\t\t\t\t<div class=\"row\">
...
\t\t\t\t\t\t\t\t\t<a target=\"_blank\" href=\"";
                // line 472
                echo twig_get_attribute($this->env, $this->source, $context["product"], "href", [], "any", false, false, false, 472);
                echo "\">
\t\t\t\t\t\t\t\t\t\t<img src=\"";
                // line 473
                echo twig_get_attribute($this->env, $this->source, $context["product"], "thumb", [], "any", false, false, false, 473);
                echo "\" alt=\"";
                echo twig_get_attribute($this->env, $this->source, $context["product"], "name", [], "any", false, false, false, 473);
                echo "\" title=\"";
                echo twig_get_attribute($this->env, $this->source, $context["product"], "name", [], "any", false, false, false, 473);
...
\t\t\t\t\t\t\t\t\t";
                // line 477
                if ( !twig_get_attribute($this->env, $this->source, $context["product"], "wish", [], "any", false, false, false, 477)) {
                    // line 478
                    ...
                    echo "\" btnname=\"";
                    echo twig_get_attribute($this->env, $this->source, $context["product"], "name", [], "any", false, false, false, 478);
                    echo "\" btnimg=\"";
                    echo twig_get_attribute($this->env, $this->source, $context["product"], "thumb", [], "any", false, false, false, 478);
                    echo "\" btnhref=\"";
                    echo twig_get_attribute($this->env, $this->source, $context["product"], "href", [], "any", false, false, false, 478);
                    echo "\" btnprice=\"";
...
\t\t\t\t\t\t\t\t\t\t\t";
                // line 493
                if (twig_get_attribute($this->env, $this->source, $context["product"], "price", [], "any", false, false, false, 493)) {
                    // line 494
...
\t\t\t\t\t\t\t\t\t\t\t\t\t";
                    ...
                    if ( !twig_get_attribute($this->env, $this->source, $context["product"], "special", [], "any", false, false, false, 495)) {
                        ...
                        echo twig_get_attribute($this->env, $this->source, $context["product"], "price", [], "any", false, false, false, 496);
                        echo "</span>
\t\t\t\t\t\t\t\t\t\t\t\t\t";
                    } else {
                        // line 498
                        echo "\t\t\t\t\t\t\t\t\t\t\t\t\t\t<span class=\"price-new\">";
                        echo twig_get_attribute($this->env, $this->source, $context["product"], "special", [], "any", false, false, false, 498);
                        echo "</span>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t<span class=\"price-old\" style=\"text-decoration: line-through;\">";
                        // line 499
                        echo twig_get_attribute($this->env, $this->source, $context["product"], "price", [], "any", false, false, false, 499);
                        echo "</span><br>
\t\t\t\t\t\t\t\t\t\t\t\t\t";
                    }
                    // line 501
                    echo "\t\t\t\t\t\t\t\t\t\t\t\t\t";
                    if (twig_get_attribute($this->env, $this->source, $context["product"], "tax", [], "any", false, false, false, 501)) {
                        // line 502
...
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t";
                        // line 503
                        echo twig_get_attribute($this->env, $this->source, $context["product"], "tax", [], "any", false, false, false, 503);
                        echo "</span>
\t\t\t\t\t\t\t\t\t\t\t\t\t";
                    }
                    // line 505
...
\t\t\t\t\t\t\t\t\t\t\t";
                ...
                // line 507
                echo "\t\t\t\t\t\t\t\t\t\t\t";
                if ((twig_get_attribute($this->env, $this->source, $context["product"], "percent", [], "any", false, false, false, 507) == null)) {
                    // line 508
                    echo "\t\t\t\t\t\t\t\t\t\t\t\t";
                } else {
                    // line 509
                    echo "\t\t\t\t\t\t\t\t\t\t\t\t\t<span style=\"text-decoration:none; color: #6c8bab;font-weight: 600;font-size:14px;\" class=\"off_p\">";
                    echo twig_get_attribute($this->env, $this->source, $context["product"], "percent", [], "any", false, false, false, 509);
                    echo "% OFF</span>
\t\t\t\t\t\t\t\t\t\t\t";
                }
                // line 511
