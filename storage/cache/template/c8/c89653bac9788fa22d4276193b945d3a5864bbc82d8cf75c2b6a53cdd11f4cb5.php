...
class __TwigTemplate_ff0c7441ea0b153d5eea0eb3166e07d8f55f701e56766e8b0a905e1eb6769b1b extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t<p >vchjbk</p></br>
\t\t\t\t\t\t\t<a href=\"\"<button class=\"btn btn-primary\" >New Arrivals</button>
\t\t\t\t\t\t</div>
\t\t\t\t\t\t<a href=\"\">
\t\t\t\t\t\t\t\t
