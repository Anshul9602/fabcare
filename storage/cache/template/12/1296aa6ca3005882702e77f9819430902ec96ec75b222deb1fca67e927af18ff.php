...
class __TwigTemplate_3bbe414e9c33a676276d847b68385def69cae38bd17095fc7ec797a0bb92ae22 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t<a href=\"";
                // line 943
                echo twig_get_attribute($this->env, $this->source, $context["product"], "href", [], "any", false, false, false, 943);
                echo "\">
\t\t\t\t\t\t\t\t<img src=\"";
                // line 944
                echo twig_get_attribute($this->env, $this->source, $context["product"], "thumb", [], "any", false, false, false, 944);
                echo "\" alt=\"";
                echo twig_get_attribute($this->env, $this->source, $context["product"], "name", [], "any", false, false, false, 944);
                echo "\" title=\"";
                echo twig_get_attribute($this->env, $this->source, $context["product"], "name", [], "any", false, false, false, 944);
...
\t\t\t\t\t\t\t<p class=\"product_name mt-10 font-16 mt-10\">";
                // line 948
                echo twig_get_attribute($this->env, $this->source, $context["product"], "name", [], "any", false, false, false, 948);
                echo "</p>
\t\t\t\t\t\t</div>
\t\t\t\t\t\t";
                // line 950
                if (twig_get_attribute($this->env, $this->source, $context["product"], "price", [], "any", false, false, false, 950)) {
                    // line 951
                    echo "\t\t\t\t\t\t\t<p class=\"price\">
\t\t\t\t\t\t\t\t";
                    // line 952
                    if ( !twig_get_attribute($this->env, $this->source, $context["product"], "special", [], "any", false, false, false, 952)) {
                        // line 953
                        echo "\t\t\t\t\t\t\t\t\t";
                        echo twig_get_attribute($this->env, $this->source, $context["product"], "price", [], "any", false, false, false, 953);
                        echo "
\t\t\t\t\t\t\t\t";
                    } else {
                        // line 955
                        echo "\t\t\t\t\t\t\t\t\t<span class=\"price-new\">";
                        echo twig_get_attribute($this->env, $this->source, $context["product"], "special", [], "any", false, false, false, 955);
                        echo "</span>
...
\t\t\t\t\t\t\t\t\t<span style=\"text-decoration:none; color: #6c8bab;font-weight: 600;font-size:16px;\" class=\"off_p\">";
                        // line 957
                        echo twig_get_attribute($this->env, $this->source, $context["product"], "percent", [], "any", false, false, false, 957);
                        echo "%
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tOFF</span>
\t\t\t\t\t\t\t\t";
                    }
                    // line 960
                    echo "\t\t\t\t\t\t\t\t";
                    if (twig_get_attribute($this->env, $this->source, $context["product"], "tax", [], "any", false, false, false, 960)) {
                        // line 961
...
\t\t\t\t\t\t\t\t\t\t";
                        // line 962
                        echo twig_get_attribute($this->env, $this->source, $context["product"], "tax", [], "any", false, false, false, 962);
                        echo "</span>
\t\t\t\t\t\t\t\t";
                    }
                    // line 964
