...
class __TwigTemplate_8db532fe677ec3ec6b4ce24bd2f03cbca08c309dc04fb0d5fa125f2ff7c683d5 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t\t\t";
                // line 436
                if ( !twig_get_attribute($this->env, $this->source, $context["product"], "wish", [], "any", false, false, false, 436)) {
                    // line 437
...
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t";
                        // line 462
                        echo twig_get_attribute($this->env, $this->source, $context["product"], "tax", [], "any", false, false, false, 462);
                        echo "</span>
\t\t\t\t\t\t\t\t\t\t\t\t\t";
                    }
                    // line 464
...
\t\t\t\t\t\t\t\t\t\t\t";
                ...
                // line 466
                echo "\t\t\t\t\t\t\t\t\t\t\t";
                if ((twig_get_attribute($this->env, $this->source, $context["product"], "percent", [], "any", false, false, false, 466) == null)) {
                    // line 467
                    echo "\t\t\t\t\t\t\t\t\t\t\t\t";
                } else {
                    // line 468
                    echo "\t\t\t\t\t\t\t\t\t\t\t\t\t<span style=\"text-decoration:none; color: #6c8bab;font-weight: 600;font-size:14px;\" class=\"off_p\">";
                    echo twig_get_attribute($this->env, $this->source, $context["product"], "percent", [], "any", false, false, false, 468);
                    echo "% OFF</span>
\t\t\t\t\t\t\t\t\t\t\t";
                }
                // line 470
