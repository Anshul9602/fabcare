...
class __TwigTemplate_b97381a72e4b2912a02354d87e07d18ffd3e9d6e0a5bd1404899a0777ec985b6 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
        ...
        // line 463
        echo "<section class=\"cares separation mt-5 container\">
...
\t\t\t\t\t\t\t\t\t<a class=\"wishlist_link \" onclick=\"wishlist.add('";
                // line 486
                echo twig_get_attribute($this->env, $this->source, $context["product"], "product_id", [], "any", false, false, false, 486);
                echo "');\">
\t\t\t\t\t\t\t\t\t\t";
                // line 487
                if ( !twig_get_attribute($this->env, $this->source, $context["product"], "wish", [], "any", false, false, false, 487)) {
                    // line 488
                    echo "
...
\t\t\t\t\t\t\t\t\t\t\tbtnsprice=\"";
                    // line 492
                    echo twig_get_attribute($this->env, $this->source, $context["product"], "special", [], "any", false, false, false, 492);
                    echo "\"
...
\t\t\t\t\t\t\t\t\t\t\t\t\t<span class=\"price-old\" style=\"text-decoration: line-through;\">";
                        // line 519
                        echo twig_get_attribute($this->env, $this->source,                         // line 520
$context["product"], "price", [], "any", false, false, false, 520);
                        echo "</span><br>
\t\t\t\t\t\t\t\t\t\t\t\t\t";
                    }
                    // line 522
                    echo "\t\t\t\t\t\t\t\t\t\t\t\t\t";
                    if (twig_get_attribute($this->env, $this->source, $context["product"], "tax", [], "any", false, false, false, 522)) {
                        // line 523
                        echo "\t\t\t\t\t\t\t\t\t\t\t\t\t<span class=\"price-tax\">";
                        echo ($context["text_tax"] ?? null);
                        echo "
\t\t\t\t\t\t\t\t\t\t\t\t\t\t";
                        // line 524
                        echo twig_get_attribute($this->env, $this->source, $context["product"], "tax", [], "any", false, false, false, 524);
                        echo "</span>
\t\t\t\t\t\t\t\t\t\t\t\t\t";
                    }
                    // line 526
...
\t\t\t\t\t\t\t\t\t\t\t\t\tclass=\"off_p\">";
                // line 530
                echo twig_get_attribute($this->env, $this->source, $context["product"], "percent", [], "any", false, false, false, 530);
                echo "% OFF</span>
