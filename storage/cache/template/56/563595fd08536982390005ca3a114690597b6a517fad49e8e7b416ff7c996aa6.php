...
class __TwigTemplate_ec454b700afb648ba32449a2e351b8091b460fbd518dccbbd3ea4b4b8557d942 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t<span class=\"elementor-button-text\" style=\"    text-transform: uppercase;\">Schedule free
\t\t\t\t\t\t\t\tpick up</span>
\t\t\t\t\t\t</span>
\t\t\t\t\t</a>
\t\t\t\t</div>
...
\t\t\t\t\t<hr>
\t\t\t\t\t<p style=\"text-align: start;\">• Express delivery would be charged 50% extra over the regular
\t\t\t\t\t\ttariff.<br>
...
\t\t\t\t\t\t• FABCARE is not responsible for fastness, colour bleed, colour running, shrinkage, damages to
\t\t\t\t\t\tembellishments or embroidery work on the articles during processing.<br>
\t\t\t\t\t\t• Every effort is made to remove stains, but will not be responsible for stubborn and
\t\t\t\t\t\tun-removable stains.<br>
\t\t\t\t\t\t• We follow a “No Claim” policy. All articles are accepted at customers’ risk. <br>
\t\t\t\t\t\t• We shall not be held responsible for:<br>
\t\t\t\t\t\t&nbsp;&nbsp; o Damage to articles that cannot withstand the normal cleaning or dry-cleaning process. <br>
\t\t\t\t\t\t&nbsp;&nbsp; o Damaged due to the ageing process of inferior quality of clothes.<br>
\t\t\t\t\t\t&nbsp;&nbsp; o Any ornaments or jewellery fittings on your clothes getting damaged during the processing.<br>
\t\t\t\t\t\t• Shrinkage, damage, cuts, holes, scratches, stains etc. becoming apparent during the wash
\t\t\t\t\t\tprocess due to defective manufacturing, adulteration, deterioration, wear & tear, and exposure
\t\t\t\t\t\tto environment.<br>
...
\t\t\t\t\t\tEmulsifier, Detergent and Softeners, Soft wash for delicate garments, Technologies like Hydro
\t\t\t\t\t\tCarbon.<br>
...
\t\t\t\t\t\t• We would not take any responsibility / Liability for:<br>
\t\t\t\t\t\t&nbsp;&nbsp;o Clothes beyond 15 days of the scheduled delivery date.<br>
\t\t\t\t\t\t&nbsp;&nbsp;o Any loss or damage to clothes arising due to fire, burglary etc. which are beyond our control
\t\t\t\t\t\t   or similar incidences.<br>
\t\t\t\t\t\t   &nbsp;&nbsp;o Valuables/article/cash, etc. inadvertently kept in the articles which is mutilated or
\t\t\t\t\t\tunrecoverable after processing.<br>
\t\t\t\t\t\t• Price List – Rates mentioned are indicative and may vary depending on the complexity of the
\t\t\t\t\t\tgarments.<br>
\t\t\t\t\t\t• Compensation for any damaged article would be limited to 10 times the value of the charges
\t\t\t\t\t\tspecified to the customer for the processing or INR 3000, whichever is lower. In case of refund,
\t\t\t\t\t\tthe item under dispute will be confiscated by the company.<br>
\t\t\t\t\t\t• All disputes are subject to the jurisdiction of courts in Uttar Pradesh only.<br>
\t\t\t\t\t\t• We may use the images of clothes for promotional purposes.<br>
\t\t\t\t\t\t• Our prices may vary from store to store and city to city.<br>
\t\t\t\t\t\t• FABCARE reserves the rights to cancel/modify/change the terms and conditions at any point in
\t\t\t\t\t\ttime without any prior intimation or notice.<br>
\t\t\t\t\t\t• For any queries, contact our customer care at 9873838000.
\t\t\t\t\t\t<br>
\t\t\t\t\t</p>
\t\t\t\t\t<div class=\"d-none\">
...
\t\t\t\t\t\t\t• We are not responsible for fastness / running of colour / shrinkage / damage to
\t\t\t\t\t\t\tembellishments
...
\t\t\t\t\t\t\t• Please note that we will not be responsible for the upkeep of the garments, if the
\t\t\t\t\t\t\tgarments
...
\t\t\t\t\t\t\tetc.<br>
\t\t\t\t\t\t\t• The tariff of garments will be decided on a case to case basis depending on the complexity
\t\t\t\t\t\t\tof
...
\t\t\t\t\t\t\t• Get free re-processing in case of processing quality issue.<br>
\t\t\t\t\t\t\t• As a promotional offer, this protection program is at zero cost for our customers.
\t\t\t\t\t\t\tHowever, it
...
\t\t\t\t\t\t\tquality issue must be reported within 7 Days of delivery. Any complaints received after 7
\t\t\t\t\t\t\tdays
...
\t\t\t\t\t\t\tcredential.<br>
\t\t\t\t\t\t\t• Express/Urgent delivery of articles would be charged 50% extra over the regular
\t\t\t\t\t\t\ttariff.<br>
\t\t\t\t\t\t\t• Customers are requested to examine the articles at the time of delivery; we would not be
\t\t\t\t\t\t\theld
\t\t\t\t\t\t\tresponsible for any damages that are found after delivery of processed articles<br>
\t\t\t\t\t\t\t• If not satisfied with the quality of any service offered, customers should get in touch
\t\t\t\t\t\t\twith
\t\t\t\t\t\t\tthe store or the company within 24 hours for resolution<br>
\t\t\t\t\t\t\t• We are not responsible for fastness, colour bleed, colour running, shrinkage, damages to
\t\t\t\t\t\t\tembellishments or embroidery work on the articles during processing<br>
\t\t\t\t\t\t\t• At UClean, we would be putting in our best efforts to remove any stains or unwanted marks
\t\t\t\t\t\t\ton
\t\t\t\t\t\t\tthe clothes; however we cannot guarantee 100% removal of stains or marks. Customers will
\t\t\t\t\t\t\thave no
\t\t\t\t\t\t\tclaim whatsoever or no rights to ask for deduction in processing charges on account of
\t\t\t\t\t\t\tthis.<br>
\t\t\t\t\t\t\t• We follow a “No Claim” policy. All articles are accepted at customers’ risk. We shall not
\t\t\t\t\t\t\tbe
...
\t\t\t\t\t\t\t• We shall not be held responsible for shrinkage, damage, cuts, holes, scratches, stains
\t\t\t\t\t\t\tetc.
...
\t\t\t\t\t\t\tincidents beyond our control or incidences of Force Majeure where we are unable to stick to
\t\t\t\t\t\t\tthe
\t\t\t\t\t\t\ttimelines. In such cases, customer cannot claim any compensation, refunds or any reduction
\t\t\t\t\t\t\tin
\t\t\t\t\t\t\tcharges.<br>
\t\t\t\t\t\t\t• We would not take any responsibility for the clothes of the customer beyond 3 (three)weeks
\t\t\t\t\t\t\tof
\t\t\t\t\t\t\tthe scheduled delivery date.<br>
\t\t\t\t\t\t\t• We accept no liability for any loss or damage to clothes arising due to fire, burglary
\t\t\t\t\t\t\tetc.
\t\t\t\t\t\t\twhich are beyond our control or similar incidences.<br>
\t\t\t\t\t\t\t• We would not take any responsibility for valuables/article/cash, etc. inadvertently kept
\t\t\t\t\t\t\tin
...
\t\t\t\t\t\t\tdecided on a case-to-case basis. This pricing would be communicated to the customer directly
\t\t\t\t\t\t\tat
\t\t\t\t\t\t\tthe store once the article has been examined by the experts present at the stores.<br>
\t\t\t\t\t\t\t• In case any piece of article or linen gets damaged during the processing for any reasons
\t\t\t\t\t\t\tother
\t\t\t\t\t\t\tthan the ones outlined above, the compensation for the customer would be limited to 10 times
\t\t\t\t\t\t\tthe
\t\t\t\t\t\t\tvalue of the charges specified to the customer for the processing or INR 3000, whichever is
\t\t\t\t\t\t\tlower.<br>
\t\t\t\t\t\t\t• All disputes are subject to the jurisdiction of courts in Delhi only.<br>
\t\t\t\t\t\t\t• UConcepts Solutions LLP reserves the rights to cancel/modify/change the terms and
\t\t\t\t\t\t\tconditions
...
\t});</script>";
    ...
    {
        return array (  383 => 341,  316 => 277,  37 => 1,);
    }
