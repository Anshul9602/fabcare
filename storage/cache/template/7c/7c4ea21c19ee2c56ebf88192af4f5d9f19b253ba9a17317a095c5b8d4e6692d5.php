...
class __TwigTemplate_7984e6b6fe593adb5365b96fa0d4bebf6506f6021ea4c171fc39de2f62313710 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t\t\t ";
        // line 293
        if ( !(null === ($context["secondary_material"] ?? null))) {
            // line 294
...
\t\t\t\t\t\t\t\t<a href=\"";
                // line 569
                echo twig_get_attribute($this->env, $this->source, $context["product"], "href", [], "any", false, false, false, 569);
                echo "\">
\t\t\t\t\t\t\t\t\t<img src=\"";
                // line 570
                echo twig_get_attribute($this->env, $this->source, $context["product"], "thumb", [], "any", false, false, false, 570);
                echo "\" alt=\"";
                echo twig_get_attribute($this->env, $this->source, $context["product"], "name", [], "any", false, false, false, 570);
                echo "\" title=\"";
                echo twig_get_attribute($this->env, $this->source, $context["product"], "name", [], "any", false, false, false, 570);
...
\t\t\t\t\t\t\t\t<p class=\"product_name mt-10 font-16 mt-10\">";
                // line 574
                echo twig_get_attribute($this->env, $this->source, $context["product"], "name", [], "any", false, false, false, 574);
                echo "</p>
\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t";
                // line 576
                if (twig_get_attribute($this->env, $this->source, $context["product"], "price", [], "any", false, false, false, 576)) {
                    // line 577
                    echo "\t\t\t\t\t\t\t\t<p class=\"price\">
\t\t\t\t\t\t\t\t\t";
                    // line 578
                    if ( !twig_get_attribute($this->env, $this->source, $context["product"], "special", [], "any", false, false, false, 578)) {
                        // line 579
                        echo "\t\t\t\t\t\t\t\t\t\t";
...
\t\t\t\t\t\t\t\t\t";
                        ...
                        echo twig_get_attribute($this->env, $this->source, $context["product"], "special", [], "any", false, false, false, 581);
                        echo "</span>
...
\t\t\t\t\t\t\t\t\t\t<span style=\"text-decoration:none; color: #6c8bab;font-weight: 600;font-size:16px;\">";
                        // line 583
                        echo twig_get_attribute($this->env, $this->source, $context["product"], "percent", [], "any", false, false, false, 583);
                        echo "% OFF</span>
\t\t\t\t\t\t\t\t\t";
                    }
                    // line 585
                    echo "\t\t\t\t\t\t\t\t\t";
                    if (twig_get_attribute($this->env, $this->source, $context["product"], "tax", [], "any", false, false, false, 585)) {
                        // line 586
...
\t\t\t\t\t\t\t\t\t\t\t";
                        // line 587
                        echo twig_get_attribute($this->env, $this->source, $context["product"], "tax", [], "any", false, false, false, 587);
                        echo "</span>
\t\t\t\t\t\t\t\t\t";
                    }
                    // line 589
