...
class __TwigTemplate_b610aecf6abd609e63575c9764a7f67e3d6b28e6feb7738b23dd33bb57b408fb extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t<a href=\"\">
\t\t\t\t\t\t\t\t<p class=\"serv-name2\">vchjbk
\t\t\t\t\t\t\t\t</p>
\t\t\t\t\t\t\t\t<img src=\"assets/img/about-us-image.jpg\" alt=\"\" style=\"width:100%\" class=\"zoom serv-img\" title=\"\"/>
\t\t\t\t\t\t\t</a>
\t\t\t\t\t\t</div>
\t\t\t\t\t
\t\t\t\t</div>
