...
class __TwigTemplate_2e834098c38cc0e0f8f8d1a18facd2350041faebe6b48521785e3adcee690a93 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t</li>
\t\t\t\t</ul>
\t\t\t\t<div style=\"background:#fff;padding:10px 10px;max-height: 150px;overflow-y: scroll;\" class=\"tab-content des-con\">
...
\t\t\t\t\t\t\t\t\t<img src=\"";
                // line 551
                echo twig_get_attribute($this->env, $this->source, $context["product"], "thumb", [], "any", false, false, false, 551);
                echo "\" alt=\"";
...
\t\t\t\t\t\t\t\t<p class=\"product_name mt-10 font-16 mt-10\">";
                // line 555
                echo twig_get_attribute($this->env, $this->source, $context["product"], "name", [], "any", false, false, false, 555);
                echo "</p>
\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t";
                // line 557
                if (twig_get_attribute($this->env, $this->source, $context["product"], "price", [], "any", false, false, false, 557)) {
                    // line 558
                    echo "\t\t\t\t\t\t\t\t<p class=\"price\">
\t\t\t\t\t\t\t\t\t";
                    // line 559
                    if ( !twig_get_attribute($this->env, $this->source, $context["product"], "special", [], "any", false, false, false, 559)) {
                        // line 560
                        echo "\t\t\t\t\t\t\t\t\t\t";
                        echo twig_get_attribute($this->env, $this->source, $context["product"], "price", [], "any", false, false, false, 560);
                        echo "
\t\t\t\t\t\t\t\t\t";
                    } else {
                        // line 562
                        echo "\t\t\t\t\t\t\t\t\t\t<span class=\"price-new\">";
                        echo twig_get_attribute($this->env, $this->source, $context["product"], "special", [], "any", false, false, false, 562);
                        echo "</span>
\t\t\t\t\t\t\t\t\t\t<span class=\"price-old\" style=\"text-decoration: line-through;\">";
                        // line 563
                        echo twig_get_attribute($this->env, $this->source, $context["product"], "price", [], "any", false, false, false, 563);
                        echo "</span><br>
\t\t\t\t\t\t\t\t\t\t<span style=\"text-decoration:none; color: #6c8bab;font-weight: 600;font-size:16px;\">";
                        // line 564
                        echo twig_get_attribute($this->env, $this->source, $context["product"], "percent", [], "any", false, false, false, 564);
                        echo "% OFF</span>
\t\t\t\t\t\t\t\t\t";
                    }
                    // line 566
                    echo "\t\t\t\t\t\t\t\t\t";
                    if (twig_get_attribute($this->env, $this->source, $context["product"], "tax", [], "any", false, false, false, 566)) {
                        // line 567
...
\t\t\t\t\t\t\t\t\t\t\t";
                        // line 568
                        echo twig_get_attribute($this->env, $this->source, $context["product"], "tax", [], "any", false, false, false, 568);
                        echo "</span>
\t\t\t\t\t\t\t\t\t";
                    }
                    // line 570
