...
class __TwigTemplate_b4041b7a919043134b3868f8d4409d2a5f0fc7343c2eec36a5153fd1b79dd552 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t\t\t\t\t<p>Closure</p>
\t\t\t\t\t\t\t\t\t\t\t<h5 class=\"pb-2\"style=\"border-bottom: 1px solid gray;\">Button</h5>
\t\t\t\t\t\t\t\t\t\t</div>
