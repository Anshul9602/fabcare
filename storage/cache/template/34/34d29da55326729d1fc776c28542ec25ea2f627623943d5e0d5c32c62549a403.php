...
class __TwigTemplate_4317ae719441757b5e7612bd6e4f46c0dbaac634e8c28f2f016c88c193e180d8 extends \Twig\Template
{
    private $source;
    private $macros = [];
            ...
            <div class=\"row\">
              <div class=\"col-sm-6\">
                <a data-toggle=\"modal\" data-target=\"#locationpopup\" id=\"hathdakhwa\">
                 <li class=\"pe-7s-map-marker\"></li> Select Pincode
                </a>
              </div>
              <div class=\"col-sm-6 text-right\">
                <li class=\"pe-7s-call\"></li> +91 8905154400
                &nbsp;&nbsp;
                <li class=\"pe-7s-map-marker\"></li> support@woodpeel.com
              </div>
            </div>
          </div>
