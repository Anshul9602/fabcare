...
class __TwigTemplate_8f3202f03658ef6f8d3d99b1fff61f0f7279a5664f8fc610c9588ba0dcb595fe extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t\t\t\t\t<strong>";
                // line 377
                echo twig_get_attribute($this->env, $this->source, $context["attribute_group"], "name", [], "any", false, false, false, 377);
                echo "</strong>
\t\t\t\t\t\t\t\t\t\t</td>
\t\t\t\t\t\t\t\t\t</tr>
\t\t\t\t\t\t\t\t</thead>
...
\t\t\t\t\t\t\t\t\t";
                // line 382
                $context['_parent'] = $context;
                $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, $context["attribute_group"], "attribute", [], "any", false, false, false, 382));
                foreach ($context['_seq'] as $context["_key"] => $context["attribute"]) {
                    // line 383
                    echo "\t\t\t\t\t\t\t\t\t\t<tr>
\t\t\t\t\t\t\t\t\t\t\t<td>";
                    // line 384
                    echo twig_get_attribute($this->env, $this->source, $context["attribute"], "name", [], "any", false, false, false, 384);
                    echo "</td>
\t\t\t\t\t\t\t\t\t\t\t<td>";
                    // line 385
                    echo twig_get_attribute($this->env, $this->source, $context["attribute"], "text", [], "any", false, false, false, 385);
                    echo "</td>
\t\t\t\t\t\t\t\t\t\t</tr>
\t\t\t\t\t\t\t\t\t";
                }
...
\t\t\t\t\t\t\t\t\t<img src=\"";
                // line 581
                echo twig_get_attribute($this->env, $this->source, $context["product"], "thumb", [], "any", false, false, false, 581);
                echo "\" alt=\"";
...
\t\t\t\t\t\t\t\t<p class=\"product_name mt-10 font-16 mt-10\">";
                // line 585
                echo twig_get_attribute($this->env, $this->source, $context["product"], "name", [], "any", false, false, false, 585);
                echo "</p>
\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t";
                // line 587
                if (twig_get_attribute($this->env, $this->source, $context["product"], "price", [], "any", false, false, false, 587)) {
                    // line 588
                    echo "\t\t\t\t\t\t\t\t<p class=\"price\">
\t\t\t\t\t\t\t\t\t";
                    // line 589
                    if ( !twig_get_attribute($this->env, $this->source, $context["product"], "special", [], "any", false, false, false, 589)) {
                        // line 590
                        echo "\t\t\t\t\t\t\t\t\t\t";
                        echo twig_get_attribute($this->env, $this->source, $context["product"], "price", [], "any", false, false, false, 590);
                        echo "
\t\t\t\t\t\t\t\t\t";
                    } else {
                        // line 592
                        echo "\t\t\t\t\t\t\t\t\t\t<span class=\"price-new\">";
                        echo twig_get_attribute($this->env, $this->source, $context["product"], "special", [], "any", false, false, false, 592);
                        echo "</span>
\t\t\t\t\t\t\t\t\t\t<span class=\"price-old\" style=\"text-decoration: line-through;\">";
                        // line 593
                        echo twig_get_attribute($this->env, $this->source, $context["product"], "price", [], "any", false, false, false, 593);
                        echo "</span><br>
\t\t\t\t\t\t\t\t\t\t<span style=\"text-decoration:none; color: #6c8bab;font-weight: 600;font-size:16px;\">";
                        // line 594
                        echo twig_get_attribute($this->env, $this->source, $context["product"], "percent", [], "any", false, false, false, 594);
                        echo "% OFF</span>
\t\t\t\t\t\t\t\t\t";
                    }
                    // line 596
                    echo "\t\t\t\t\t\t\t\t\t";
                    if (twig_get_attribute($this->env, $this->source, $context["product"], "tax", [], "any", false, false, false, 596)) {
                        // line 597
...
\t\t\t\t\t\t\t\t\t\t\t";
                        // line 598
                        echo twig_get_attribute($this->env, $this->source, $context["product"], "tax", [], "any", false, false, false, 598);
                        echo "</span>
\t\t\t\t\t\t\t\t\t";
                    }
                    // line 600
