...
class __TwigTemplate_19f4d0e8a638db0aba91f116caad3f00f86851d8277cbeb6f1544f3da695524e extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t\t<i class=\"fa-solid fa-heart\" style=\"font-size:17px;\"></i>
\t\t\t\t\t\t\t\tadd to wishlist
\t\t\t\t\t\t\t</a>
\t\t\t\t\t\t</p>
\t\t\t\t\t</div>
