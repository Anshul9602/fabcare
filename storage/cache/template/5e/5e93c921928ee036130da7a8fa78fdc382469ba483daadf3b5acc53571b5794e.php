...
class __TwigTemplate_df611187c843aee2f7a7aa25f367f37f9819198775bd77550f65ad03f5d74bfe extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t\t<button type=\"button\" style='float:left; max-width:50%' id=\"button-cart\" data-loading-text=\"";
        // line 345
        echo ($context["text_loading"] ?? null);
...
\t\t\t\t\t\t\t\t\t";
        ...
        echo "
\t\t\t\t\t\t\t\t</button>
\t\t\t\t\t\t\t\t<button type=\"button\" id=\"button-buy\" style='float:right; max-width:50%;' class=\"col-md-6 col-5 btn btn-primary btn-lg \">
