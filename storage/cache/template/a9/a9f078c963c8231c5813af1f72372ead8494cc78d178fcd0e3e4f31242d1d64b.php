...
class __TwigTemplate_00f7887c1c45776c2d638aceae6394eccad44aef4a9366b355297cd218848cab extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t\t
\t\t\t\t\t\t\t\tPlease Note: We don’t have refund policies except the policies mentioned above in cancellation policies section.<br><br><br>
\t\t\t\t\t\t\t\t
...
\t\t\t\t\t\t\t\tIf it is not possible to correct the damaged area good as new, we’ll replace.<br>
\t\t\t\t\t\t\t\t
\t\t\t\t\t\t\t\t2) What if the product is defective?<br>
\t\t\t\t\t\t\t\tIn case product delivered to you is defective, we’ll replace. Eligibility for replacement (e.g., imbalance or unevenness of more than 5mm, wooden joints opening, termites & wood borer infestations etc.).<br>
