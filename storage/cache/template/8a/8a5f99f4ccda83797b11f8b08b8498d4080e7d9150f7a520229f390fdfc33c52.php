...
class __TwigTemplate_86da9bc838b11d0a8f9de75e785d48bbed9f057c64dde96bb680e4488bcbe3c2 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
const productname = e.target.getAttribute(\"\");
const productprice = e.target.getAttribute(\"btnprice\");
const productsprice = e.target.getAttribute(\"btnnewprice\");
const productimg = e.target.getAttribute(\"src\");
const producturl = e.target.getAttribute(\"href\");
console.log(productId, productprice, productsprice, productname, producturl);
...
const isProductIdExist = wishlistFromLocalStorage.find((item) => item === productId);

if (! isProductIdExist) {
wishlistFromLocalStorage.push(productId, produtname, productprice, produtimg);
...
\t";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["style"]) {
            // line 210
            echo "\t\t<link href=\"";
            echo twig_get_attribute($this->env, $this->source, $context["style"], "href", [], "any", false, false, false, 210);
            echo "\" type=\"text/css\" rel=\"";
            echo twig_get_attribute($this->env, $this->source, $context["style"], "rel", [], "any", false, false, false, 210);
            echo "\" media=\"";
            echo twig_get_attribute($this->env, $this->source, $context["style"], "media", [], "any", false, false, false, 210);
            echo "\"/>
\t";
        }
        $_parent = $context['_parent'];
...
";
    ...
    {
        return array (  331 => 215,  322 => 213,  317 => 212,  304 => 210,  300 => 209,  203 => 117,  195 => 114,  187 => 111,  179 => 108,  172 => 104,  167 => 101,  161 => 97,  150 => 94,  147 => 93,  143 => 92,  137 => 88,  135 => 87,  97 => 54,  80 => 42,  37 => 1,);
    }
