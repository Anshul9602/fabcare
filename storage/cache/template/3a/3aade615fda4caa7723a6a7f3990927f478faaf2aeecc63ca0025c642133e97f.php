...
class __TwigTemplate_7459ff3d3c2ee48ee0593e6be089b7997a3174e910fe66b56d7efe0d10549bc3 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t\t\t\t</a>
\t\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t\t<div class=\"bestSeller_TT\">TOP SELLER</div>
\t\t\t\t\t\t\t\t\t<a class=\"wishlist_link \" onclick=\"wishlist.add('";
                // line 309
...
\t\t\t\t\t<a href=\"";
                // line 402
                echo twig_get_attribute($this->env, $this->source, $context["category1"], "href", [], "any", false, false, false, 402);
                echo "\"><img
\t\t\t\t\t\t\tdata-src=\"";
                // line 403
                echo twig_get_attribute($this->env, $this->source, $context["category1"], "thumb", [], "any", false, false, false, 403);
                echo "\"
...
\t\t\t\t\t\t\t<h6 class=\"card-title text-center\">";
                // line 407
                echo twig_get_attribute($this->env, $this->source, $context["category1"], "name", [], "any", false, false, false, 407);
                echo "</h6>
