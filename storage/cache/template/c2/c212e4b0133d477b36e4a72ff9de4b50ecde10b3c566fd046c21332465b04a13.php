...
class __TwigTemplate_96a19fcf8a26643282b2c84ba8e784b124f2c22e28c881cd9464be485303464d extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t\t\t\t\t\t\t\tbtnhref=\"";
        // line 189
        echo twig_get_attribute($this->env, $this->source, ($context["product"] ?? null), "href", [], "any", false, false, false, 189);
        echo "\" btnprice=\"";
        echo twig_get_attribute($this->env, $this->source, ($context["product"] ?? null), "price", [], "any", false, false, false, 189);
        echo "\"
\t\t\t\t\t\t\t\t\t\t\t\t\t\tbtnsprice=\"";
        // line 190
        echo twig_get_attribute($this->env, $this->source, ($context["product"] ?? null), "special", [], "any", false, false, false, 190);
        echo "\"
\t\t\t\t\t\t\t\t\t\t\t\t\t\tstyle=\"color: #4a4975;
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tfont-size:35px;\"></i>
\t\t\t\t\t\t\t\t\t\t\t\t</a>
...
\t\t\t\t\t\t\t\t";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["category"]) {
                // line 305
                echo "\t\t\t\t\t\t\t\t";
                if (twig_get_attribute($this->env, $this->source, $context["category"], "children", [], "any", false, false, false, 305)) {
                    // line 306
                    echo "\t\t\t\t\t\t\t\t<li class=\"menu-item-has-children\">
\t\t\t\t\t\t\t\t\t";
                    // line 307
                    $context["myVariable"] = twig_get_attribute($this->env, $this->source, $context["category"], "href", [], "any", false, false, false, 307);
                    // line 308
                    echo "\t\t\t\t\t\t\t\t\t<a href=\"";
...
\t\t\t\t\t\t\t\t\t\t";
                    // line 310
                    $context['_parent'] = $context;
                    $context['_seq'] = twig_ensure_traversable(twig_array_batch(twig_get_attribute($this->env, $this->source, $context["category"], "children", [], "any", false, false, false, 310), (twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, $context["category"], "children", [], "any", false, false, false, 310)) / twig_round(twig_get_attribute($this->env, $this->source,                     // line 311
$context["category"], "column", [], "any", false, false, false, 311), 1, "ceil"))));
...
\t\t\t\t\t\t\t\t\t\t\t<a href=\"";
                            // line 314
                            echo twig_get_attribute($this->env, $this->source, $context["child"], "href", [], "any", false, false, false, 314);
                            echo "\">";
                            echo twig_get_attribute($this->env, $this->source, $context["child"], "name", [], "any", false, false, false, 314);
                            echo "</a>
\t\t\t\t\t\t\t\t\t\t</li>
\t\t\t\t\t\t\t\t\t\t";
                        }
...
\t\t\t\t\t\t\t\t\t<a href=\"";
                    // line 322
                    echo twig_get_attribute($this->env, $this->source, $context["category"], "href", [], "any", false, false, false, 322);
                    echo "\" class=\"\">";
                    echo twig_get_attribute($this->env, $this->source, $context["category"], "name", [], "any", false, false, false, 322);
                    echo "</a>
\t\t\t\t\t\t\t\t</li>
...
\t</script>
    ...
    {
        return array (  696 => 384,  669 => 359,  664 => 357,  660 => 356,  656 => 355,  651 => 354,  646 => 352,  642 => 351,  638 => 350,  634 => 349,  630 => 348,  625 => 347,  623 => 346,  605 => 330,  600 => 327,  594 => 326,  585 => 322,  582 => 321,  577 => 318,  571 => 317,  560 => 314,  557 => 313,  552 => 312,  549 => 311,  547 => 310,  539 => 308,  537 => 307,  534 => 306,  531 => 305,  527 => 304,  523 => 302,  521 => 301,  509 => 292,  473 => 259,  466 => 255,  457 => 249,  453 => 248,  419 => 217,  401 => 202,  393 => 197,  383 => 190,  377 => 189,  371 => 188,  367 => 187,  363 => 186,  359 => 185,  354 => 182,  346 => 179,  338 => 176,  335 => 175,  327 => 172,  319 => 169,  311 => 166,  308 => 165,  306 => 164,  295 => 158,  283 => 149,  268 => 141,  264 => 140,  190 => 68,  181 => 66,  176 => 65,  165 => 63,  161 => 62,  158 => 61,  149 => 59,  144 => 58,  131 => 56,  127 => 55,  92 => 22,  86 => 20,  83 => 19,  77 => 17,  75 => 16,  71 => 15,  66 => 13,  54 => 6,  47 => 4,  41 => 3,  37 => 1,);
    }
