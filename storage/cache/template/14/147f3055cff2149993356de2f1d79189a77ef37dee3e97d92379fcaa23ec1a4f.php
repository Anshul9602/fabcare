...
class __TwigTemplate_da64ac514c1714668687772071131f61092d28288ee4b88f72c70ed16884f7bd extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t<span class=\"hb\" style=\"display: flex;justify-content: center;    background: #6c8bab;\"></span>
\t\t\t\t</h1>
\t\t\t</div>
\t\t\t<p class=\"section-header__title mt-1 text-center\">
