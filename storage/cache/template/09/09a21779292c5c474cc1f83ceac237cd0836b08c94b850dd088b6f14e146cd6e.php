...
class __TwigTemplate_ad512f724d524e78c0a3c77a37d5efc6c515eb3df042b29abcda77c61093930b extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t\t</a>
\t\t\t\t\t\t\t\t<a class=\"add\" style=\"font-size:14px; text-transform:uppercase ;cursor:pointer;display: inline-block;\" onclick=\"wishlist.remove('";
        // line 230
        echo twig_get_attribute($this->env, $this->source, ($context["product"] ?? null), "product_id", [], "any", false, false, false, 230);
        echo "');\">
