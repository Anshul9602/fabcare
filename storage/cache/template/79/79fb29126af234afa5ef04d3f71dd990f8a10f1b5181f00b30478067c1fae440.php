...
class __TwigTemplate_eadace372bbc0fd7b3d44d217a4746703354f10680a22038257faeb51b441baf extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t<p class=\"\">GET ADDITIONAL 5% DISCOUNT ON YOUR FIRST PURCHASE. USE CODE:
\t\t\t\t\t\t\t\t<span class=\"color:black;font-weight: 600;font-size: 14px;\">FIRST5</span>
\t\t\t\t\t\t\t</p>
