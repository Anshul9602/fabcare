...
class __TwigTemplate_a70ed9aa54b05feaf79a8b33d1e03d4257ba061dc11c22d6abc0dbb90c9bc08e extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t\t\t\t\t\t";
                // line 286
                if (twig_get_attribute($this->env, $this->source, $context["product"], "price", [], "any", false, false, false, 286)) {
                    // line 287
                    echo "\t\t\t\t\t\t\t\t\t\t\t\t<p class=\"price mb-0\">
\t\t\t\t\t\t\t\t\t\t\t\t\t";
                    // line 288
                    if ( !twig_get_attribute($this->env, $this->source, $context["product"], "special", [], "any", false, false, false, 288)) {
                        // line 289
...
\t\t\t\t\t\t\t\t\t\t\t\t\t";
                        ...
                        // line 291
                        echo "\t\t\t\t\t\t\t\t\t\t\t\t\t<span class=\"price-new\">";
                        echo twig_get_attribute($this->env, $this->source, $context["product"], "special", [], "any", false, false, false, 291);
                        echo "</span>
\t\t\t\t\t\t\t\t\t\t\t\t\t<span class=\"price-old\" style=\"text-decoration: line-through;\">";
                        // line 292
                        echo twig_get_attribute($this->env, $this->source,                         // line 293
$context["product"], "price", [], "any", false, false, false, 293);
                        echo "</span><br>
\t\t\t\t\t\t\t\t\t\t\t\t\t";
                    }
                    // line 295
...
\t\t\t\t\t\t\t\t\t\t";
                // line 354
                if ( !twig_get_attribute($this->env, $this->source, $context["product"], "wish", [], "any", false, false, false, 354)) {
                    // line 355
                    echo "
...
\t\t\t\t\t\t\t\t\t\t\tbtnname=\"";
                    ...
                    echo "\" btnimg=\"";
                    echo twig_get_attribute($this->env, $this->source, $context["product"], "thumb", [], "any", false, false, false, 357);
                    echo "\"
\t\t\t\t\t\t\t\t\t\t\tbtnhref=\"";
                    // line 358
                    echo twig_get_attribute($this->env, $this->source, $context["product"], "href", [], "any", false, false, false, 358);
                    echo "\" btnprice=\"";
                    echo twig_get_attribute($this->env, $this->source, $context["product"], "price", [], "any", false, false, false, 358);
                    echo "\"
\t\t\t\t\t\t\t\t\t\t\tbtnsprice=\"";
                    // line 359
                    echo twig_get_attribute($this->env, $this->source, $context["product"], "special", [], "any", false, false, false, 359);
                    echo "\"
\t\t\t\t\t\t\t\t\t\t\tstyle=\"color: #4a4975; font-size:24px;\"></i>
...
\t\t\t\t\t\t\t\t\t\t\t\t<a target=\"_blank\" href=\"";
                // line 374
                echo twig_get_attribute($this->env, $this->source, $context["product"], "href", [], "any", false, false, false, 374);
                echo "\">
\t\t\t\t\t\t\t\t\t\t\t\t\t<h4 class=\"product_name\">";
                // line 375
...
\t\t\t\t\t\t\t\t\t\t\t\t";
                // line 380
                if (twig_get_attribute($this->env, $this->source, $context["product"], "price", [], "any", false, false, false, 380)) {
                    // line 381
                    echo "\t\t\t\t\t\t\t\t\t\t\t\t<p class=\"price mb-0\">
\t\t\t\t\t\t\t\t\t\t\t\t\t";
                    // line 382
                    if ( !twig_get_attribute($this->env, $this->source, $context["product"], "special", [], "any", false, false, false, 382)) {
                        // line 383
                        echo "\t\t\t\t\t\t\t\t\t\t\t\t\t<span class=\"price-new\">";
...
\t\t\t\t\t\t\t\t\t\t\t\t\t";
                        ...
                        // line 385
                        echo "\t\t\t\t\t\t\t\t\t\t\t\t\t<span class=\"price-new\">";
                        echo twig_get_attribute($this->env, $this->source, $context["product"], "special", [], "any", false, false, false, 385);
                        echo "</span>
\t\t\t\t\t\t\t\t\t\t\t\t\t<span class=\"price-old\" style=\"text-decoration: line-through;\">";
                        // line 386
                        echo twig_get_attribute($this->env, $this->source,                         // line 387
$context["product"], "price", [], "any", false, false, false, 387);
                        echo "</span>
\t\t\t\t\t\t\t\t\t\t\t\t\t";
                    }
                    // line 389
...
\t\t\t\t\t\t\t\t\t\t\t\t\t\t";
                        // line 391
                        echo twig_get_attribute($this->env, $this->source, $context["product"], "tax", [], "any", false, false, false, 391);
                        echo "</span>
\t\t\t\t\t\t\t\t\t\t\t\t\t";
                    }
                    // line 393
...
\t\t\t\t\t\t\t\t\t\t\t\t\tclass=\"off_p\">";
                // line 397
                echo twig_get_attribute($this->env, $this->source, $context["product"], "percent", [], "any", false, false, false, 397);
                echo "% OFF</span>
...
\t\t\t\t\t<a href=\"";
                // line 450
                echo twig_get_attribute($this->env, $this->source, $context["category1"], "href", [], "any", false, false, false, 450);
                echo "\">
\t\t\t\t\t\t<img  alt=\"\"
\t\t\t\t\t\t\tsrc=\"";
                // line 452
                echo twig_get_attribute($this->env, $this->source, $context["category1"], "thumb", [], "any", false, false, false, 452);
                echo "\">
...
\t\t
\t\t</div>
\t\t<section class=\"home-testimonial-bottom mb-2\">
...
";
    ...
    {
        return array (  887 => 637,  776 => 528,  719 => 471,  708 => 462,  692 => 452,  687 => 450,  682 => 447,  678 => 446,  661 => 431,  659 => 430,  639 => 412,  636 => 411,  616 => 397,  612 => 395,  608 => 393,  603 => 391,  598 => 390,  595 => 389,  590 => 387,  589 => 386,  584 => 385,  578 => 383,  576 => 382,  573 => 381,  571 => 380,  563 => 375,  559 => 374,  552 => 369,  545 => 364,  537 => 359,  531 => 358,  525 => 357,  521 => 356,  518 => 355,  516 => 354,  512 => 353,  505 => 349,  499 => 348,  495 => 347,  488 => 342,  483 => 341,  481 => 340,  456 => 317,  453 => 316,  434 => 303,  430 => 301,  426 => 299,  421 => 297,  416 => 296,  413 => 295,  408 => 293,  407 => 292,  402 => 291,  396 => 289,  394 => 288,  391 => 287,  389 => 286,  381 => 281,  377 => 280,  371 => 276,  365 => 272,  359 => 269,  353 => 268,  347 => 267,  342 => 266,  340 => 265,  336 => 264,  329 => 260,  323 => 259,  319 => 258,  313 => 254,  308 => 253,  306 => 252,  284 => 232,  275 => 229,  270 => 228,  266 => 227,  37 => 1,);
    }
