...
class __TwigTemplate_6d231ea50391f5aa7da1bd4c7ccd665dedb5dbd729251bd2a32a661b3b5c7c7e extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t\t&nbsp;";
        ...
        echo "</a>
\t\t\t\t\t\t\t&nbsp;&nbsp;&nbsp;
\t\t\t\t\t\t\t<a style=\"font-size:14px; text-transform:uppercase ;cursor:pointer;\" onclick=\"wishlist.add('";
        // line 224
        echo ($context["product_id"] ?? null);
        echo "');\">
\t\t\t\t\t\t\t\t<i class=\"fa fa-heart-o \" style=\"font-size:17px;\"></i>
\t\t\t\t\t\t\t\tadd to wishlist
\t\t\t\t\t\t\t</a>
\t\t\t\t\t\t</p>
\t\t\t\t\t</div>
...
\t\t\t\t\t\t";
                // line 952
                if (twig_get_attribute($this->env, $this->source, $context["product"], "price", [], "any", false, false, false, 952)) {
                    // line 953
                    echo "\t\t\t\t\t\t\t<p class=\"price\">
\t\t\t\t\t\t\t\t";
                    // line 954
                    if ( !twig_get_attribute($this->env, $this->source, $context["product"], "special", [], "any", false, false, false, 954)) {
                        // line 955
                        echo "\t\t\t\t\t\t\t\t\t";
                        echo twig_get_attribute($this->env, $this->source, $context["product"], "price", [], "any", false, false, false, 955);
                        echo "
\t\t\t\t\t\t\t\t";
                    } else {
                        // line 957
                        echo "\t\t\t\t\t\t\t\t\t<span class=\"price-new\">";
                        echo twig_get_attribute($this->env, $this->source, $context["product"], "special", [], "any", false, false, false, 957);
                        echo "</span>
\t\t\t\t\t\t\t\t\t<span class=\"price-old\" style=\"text-decoration: line-through;\">";
                        // line 958
                        echo twig_get_attribute($this->env, $this->source, $context["product"], "price", [], "any", false, false, false, 958);
                        echo "</span><br>
\t\t\t\t\t\t\t\t\t<span style=\"text-decoration:none; color: #6c8bab;font-weight: 600;font-size:16px;\" class=\"off_p\">";
                        // line 959
                        echo twig_get_attribute($this->env, $this->source, $context["product"], "percent", [], "any", false, false, false, 959);
                        echo "%
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tOFF</span>
\t\t\t\t\t\t\t\t";
                    }
                    // line 962
                    echo "\t\t\t\t\t\t\t\t";
                    if (twig_get_attribute($this->env, $this->source, $context["product"], "tax", [], "any", false, false, false, 962)) {
                        // line 963
...
\t\t\t\t\t\t\t\t\t\t";
                        // line 964
                        echo twig_get_attribute($this->env, $this->source, $context["product"], "tax", [], "any", false, false, false, 964);
                        echo "</span>
\t\t\t\t\t\t\t\t";
                    }
                    // line 966
